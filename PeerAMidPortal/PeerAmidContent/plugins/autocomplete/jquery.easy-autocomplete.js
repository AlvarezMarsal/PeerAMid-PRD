        ...
        function prepareDefaults() {
            ...
            if (options.categories !== undefined && options.categories instanceof Array) {
                ...
                for (var i = 0, length = options.categories.length; i < length; i += 1) {
                    ...
                    for (let property in defaults.categories[0]) {
    ...
    scope.ListBuilderService = function ListBuilderService(configuration, proccessResponseData) {
        ...
        this.updateCategories = function(listBuilder, data) {
            ...
            if (configuration.get("categoriesAssigned")) {
                ...
                for (let i = 0; i < configuration.get("categories").length; i += 1) {

                    const builder = convertToListBuilder(configuration.get("categories")[i], data);
        ...
        this.convertXml = function(listBuilder) {
            if (configuration.get("dataType").toUpperCase() === "XML") {
                ...
                for (let i = 0; i < listBuilder.length; i += 1) {
...
var EasyAutocomplete = (function(scope) {
    ...
    scope.proccess = function DataProcessor(config, listBuilder, phrase) {
        ...
        const inputPhrase = phrase; // TODO REFACTOR
...
var EasyAutocomplete = (function(scope) {
    ...
    scope.Template = function Template(options) {
        ...
        const prepareBuildMethod = function(options) {
        ...
        const templateClass = function(options) {
            const emptyStringFunction = function() {
                return "";
            };
    ...
    scope.main = function Core($input, options) {
        ...
        function prepareField() {
            ...
            function createWrapper() {
                const $wrapper = $("<div>");
                var classes = consts.getValue("WRAPPER_CSS_CLASS");
                    ...
                    $elements_container
                        ...
                        .on("loadElements.eac",
                            function(event, listBuilders, phrase) {
                                ...
                                var $item = "";
                                const $listContainer = $elements_container.find("ul");
                                ...
                                for (var builderIndex = 0, listBuildersLength = listBuilders.length;
                                    ...
                                    if (listBuilders[builderIndex].header !== undefined &&
                                        ...
                                        $listContainer.append(
                                            `<div class='eac-category' >${listBuilders[builderIndex].header}</div>`);
                                    }

                                    for (var i = 0, listDataLength = listData.length;
                                        i < listDataLength && counter < listBuilders[builderIndex].maxListSize;
                                        i += 1) {
                    ...
                    .keyup(function(event) {
                        ...
                        function loadData(inputPhrase) {
                            ...
                            if (config.get("data") !== "list-required") {
                                ...
                                let listBuilders = listBuilderService.init(data);
                            ...
                            const settings = createAjaxSettings();
                            ...
                            function createAjaxSettings() {
                                ...
                                const settings = {};
                                const ajaxSettings = config.get("ajaxSettings") || {};

                                for (let set in ajaxSettings) {
...
(function($) {
    ...
    $.fn.easyAutocomplete = function(options) {
        ...
        return this.each(function() {
            const $this = $(this);
            const eacHandle = new EasyAutocomplete.main($this, options);
