...
(function(factory) {
    ...
    Autocomplete.prototype = {
        ...
        fixPosition: function() {
            ...
            const height = that.el.outerHeight();
            const offset = that.el.offset();
        ...
        isCursorAtEnd: function() {
            ...
            const selectionStart = that.element.selectionStart;
            var range;
        ...
        getSuggestionsLocal: function(query) {
            ...
            data = {
                suggestions: $.grep(options.lookup,
                    function(suggestion) {
        ...
        selectHint: function() {
            const that = this;
            const i = $.inArray(that.hint, that.suggestions);
        ...
        moveUp: function() {
            ...
            if (that.selectedIndex === 0) {
                $(that.suggestionsContainer).children(`.${that.classes.suggestion}`).first()
        ...
        getValue: function(value) {
            const that = this;
            const delimiter = that.options.delimiter;
            var currentValue,
                parts;
