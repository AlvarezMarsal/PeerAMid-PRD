(function() {
    ...
    window.AmCharts
        ...
        : (d = {}, window.AmCharts = d, d.themes = {}, d.maps = {}, d.inheriting = {}, d.charts = [], d.onReadyArray =
            [], d.useUTC = !1, d.updateRate = 60, d.uid = 0, d.lang = {}, d.translations = {}, d.mapTranslations =
            {}, d.windows = {}, d.initHandlers = [], d.amString = "am", d.pmString = "pm");
    d.Class = function(a) {
        var b = function() {
        ...
        a.inherits
            ...
            : (b.prototype.createEvents =
                    function() { for (var a = 0; a < arguments.length; a++) this.events[arguments[a]] = [] },
    ...
    d.getIEVersion = function() {
        ...
        (b = navigator.userAgent, c =
            /MSIE ([0-9]{1,}[.0-9]{0,})/, null !== c.exec(b) && (a = parseFloat(RegExp.$1)));
        return a;
    };
    d.applyLang = function(a, b) {
        ...
        c &&
            ...
            (b.dayNames = d.extend({}, c.dayNames), b.shortDayNames = d.extend({}, c.shortDayNames), b.monthNames =
                d.extend({}, c.monthNames), b.shortMonthNames = d.extend({}, c.shortMonthNames)), c.am &&
                (b.amString = c.am), c.pm && (b.pmString = c.pm));
    ...
    d.isNN &&
    (document.addEventListener("mousemove", d.handleMouseMove), document.addEventListener("mouseup",
        d.handleMouseUp,
        !0), window.addEventListener("load", d.handleLoad, !0));
    d.isIE &&
    ...
    d.addWheelListeners = function() {
        d.wheelIsListened ||
        (d.isNN &&
        (window.addEventListener("DOMMouseScroll", d.handleWheel, !0), document.addEventListener("mousewheel",
            d.handleWheel,
            !0)), d.isIE && document.attachEvent("onmousewheel", d.handleWheel));
        d.wheelIsListened = !0;
    };
    d.clear = function() {
        var a = d.charts;
    ...
    d.update = function() {
        ...
        if (a)
            for (var c = a.length - 1; 0 <= c; c--)
                a[c].update && a[c].update(), b &&
                    (a[c].autoResize ? a[c].validateSize && a[c].validateSize() : a[c].premeasure && a[c].premeasure());
...
(function() {
    ...
    d.toCoordinate = function(a, b, c) {
        var e;
        void 0 !== a &&
        (a = String(a), c && c < b && (b = c), e = Number(a), -1 != a.indexOf("!") &&
    ...
    d.formatValue = function(a, b, c, e, g, f, h, k) {
        if (b) {
            ...
            for (l = 0; l < c.length; l++) {
                var m = c[l], p = b[m];
                void 0 !== p &&
                (p = f ? d.addPrefix(p, k, h, e) : d.formatNumber(p, e), a =
                    a.replace(new RegExp("\\[\\[" + g + "" + m + "\\]\\]", "g"), p));
            }
        }
        return a;
    };
    ...
    d.parseDefs = function(a, b) {
        for (var c in a) {
            ...
            if (0 < a[c].length && "object" == e)
                ...
                "object" == e
                    ? (e =
                        document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c], e))
...
(function() {
    ...
    d.AxisBase = d.Class({
        construct: function(a) {
            ...
            this.dateFormats = [
                { period: "fff", format: "NN:SS.QQQ" }, { period: "ss", format: "JJ:NN:SS" },
        ...
        draw: function() {
            ...
            this.autoGridCount
                ? ("V" == this.orientation
                    ...
                    : a = this.width / this.minHorizontalGap, this.gridCountR = Math.max(a, 1))
        ...
        positionTitle: function() {
            ...
            if (a) {
                ...
                0 < e.length()
                    ? g = e.getBBox()
                    : (g.x = 0, g.y = 0, g.width = this.width, g.height =
                ...
                case "right":
                    b = e + h + 10 + p, q && (b += 7), c =
                        ("left" == n ? l + 2 : "right" == n ? -2 : l / 2) + this.titleDY, m = -90;
                }
        ...
        pushAxisItem: function(a, b) {
            ...
            if (e = a.getLabel())
                c.labelsSet.push(e), e.click(function(b) { c.handleMouse(b, a, "clickItem") })
                    .touchend(function(b) { c.handleMouse(b, a, "clickItem") })
        ...
        parseDatesDraw: function() {
            ...
            a &&
                1 < u &&
                (w = this.chooseMinorFrequency(u), x =
                    d.getPeriodDuration(A, w), "DD" == A && (x += d.getPeriodDuration("hh")), "fff" == A && (x = 1));
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount &&
                    ...
                    "MM" == A &&
                    (g = (n - l) / y, 1.5 <= (n - l) / y &&
                    (n = n - (g - 1) * y + d.getPeriodDuration("DD", 3), n =
                        d.resetDateToMin(new Date(n), A, 1).getTime(), C += y));
                    g = (n - this.startTime) * this.stepWidth;
                    if ("radar" == b.type) {
                    ...
                    f = !1;
                    this.nextPeriod[h] && (f = this.checkPeriodChange(this.nextPeriod[h], 1, n, l, h));
                    l = !1;
                    f && this.markPeriodChange
                        ? (f = this.dateFormatsObject[this.nextPeriod[h]], this.twoLineMode &&
                    ...
                    this.boldLabels && (l = !0);
                    m = new this.axisItemRenderer(this, g, f, !1, p, K, !1, l);
                    this.pushAxisItem(m);
                    m = l = n;
                    if (!isNaN(w))
                        for (g = 1; g < u; g += w)
                            this.gridAlpha = this.minorGridAlpha, f = n + x * g, f =
                                d.resetDateToMin(new Date(f), A, w, t).getTime(), f = new this.axisItemRenderer(this,
        ...
        createBalloon: function() {
            ...
            b &&
            (b = b.cursorPosition, "mouse" != b && (this.stickBalloonToCategory = !0), "start" == b &&
                (this.stickBalloonToStart = !0), "ValueAxis" == this.cname && (this.stickBalloonToCategory = !1));
...
(function() {
    ...
    d.ValueAxis = d.Class({
        ...
        updateData: function() {
            ...
            var a = this.chart;
            "xy" != a.type &&
            (this.stackGraphs("smoothedLine"), this.stackGraphs("line"), this.stackGraphs("column"), this
                .stackGraphs("step"));
            ...
            this.synchronizationMultiplier && this.synchronizeWith
                ...
                : (this.foundGraphs = !1, this.getMinMax(), 0 === this.start &&
                    this.end == this.data.length - 1 &&
                    isNaN(this.minZoom) &&
                    isNaN(this.maxZoom) &&
                    (this.fullMin = this.min, this.fullMax =
                            this.max, "date" != this.type &&
                            this.strictMinMax &&
                            (isNaN(this.minimum) || (this.fullMin = this.minimum), isNaN(this.maximum) ||
                                (this.fullMax = this.maximum)),
                        this.logarithmic &&
                            (this.fullMin = this.logMin, 0 === this.fullMin && (this.fullMin = this.treatZeroAs)),
                        "date" == this.type &&
                        (this.minimumDate || (this.fullMin = this.minRR), this.maximumDate ||
                                (this.fullMax = this.maxRR),
                            this.strictMinMax &&
                            (this.minimumDate && (this.fullMin = this.minimumDate.getTime()), this.maximumDate &&
        ...
        draw: function() {
            ...
            "date" == c &&
            (this.logarithmic = !1, this.min = this.minRR,
            ...
            if (isNaN(this.min) ||
                ...
                if (this.logarithmic) {
                    ...
                    this.relativeStart =
                        d.roundTo((Math.log(this.minReal) / Math.LN10 - Math.log(h) * Math.LOG10E) / r, 5);
                    this.relativeEnd = d.roundTo(w / r, 5);
                } else
                    this.relativeStart =
                        d.roundTo(d.fitToBounds((this.min - this.fullMin) / (this.fullMax - this.fullMin), 0, 1),
                            5), this.relativeEnd =
                ...
                !0 === g
                    ? (z = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth =
                        this.axisWidth / z, z > this.logGridLimit &&
                    (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, t =
                ...
                isNaN(w) || (x = w);
                isNaN(this.maxZoom) &&
                (this.max = d.roundTo(this.max, this.maxDecCount), this.min =
                    d.roundTo(this.min, this.maxDecCount));
                h = {};
                h.precision = x;
                ...
                if (this.autoGridCount || 0 !== this.gridCount)
                    if ("date" == c)
                        this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime =
                            this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw();
                    else
                        for (r >= this.autoRotateCount &&
                                !isNaN(this.autoRotateAngle) &&
                                (this.labelRotationR = this.autoRotateAngle),
                            c = this.minCalc, g && (r++, c = this.maxCalc - r * x), this.gridCountReal = r, h =
                                this.startCount = t;
                            h < r;
                            h += n)
                            if (t = x * h + c, t =
                                d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t)
                                if (isNaN(w) || Number(d.toFixed(t, w)) == t) {
                                    if (!0 === g)
                                        if (z > this.logGridLimit) t = Math.pow(10, h);
                                    ...
                                    if (t == this.baseValue && "radar" != a.type) {
                                        ...
                                        "H" == this.orientation
                                            ? 0 <= f && f <= K + 1 && (D = [f, f, f + k], C = [H, 0, l])
                                            : 0 <= f && f <= H + 1 && (D = [0, K, K + k], C = [f, f, f + l]);
                                        D &&
                                        (f = d.fitToBounds(2 * this.gridAlpha, 0, 1),
                                            isNaN(this.zeroGridAlpha) || (f = this.zeroGridAlpha), f =
                                                d.line(a.container, D, C, this.gridColor, f, 1, this.dashLength),
                                            f.translate(this.x, this.y), this.grid0 =
                                                f, a.axesSet.push(f), f.toBack(), d.setCN(a,
                                                f,
                                                this.bcn + "zero-grid-" + this.id),
                                            d.setCN(a, f, this.bcn + "zero-grid"));
                                    }
                                    if (!isNaN(y) && 0 < A && h < r - 1) {
                                        f = x / y;
                                        g &&
                                        (y = x * (h + n) + this.minCalc, y =
                                            d.roundTo(y, this.maxDecCount + 1), z > this.logGridLimit &&
                                            (y = Math.pow(10, h + n)), f = 9, y = (y - t) / f);
                                        K = this.gridAlpha;
                ...
                if (0 < B) {
                    ...
                    for (h = this.fillAlpha = 0; h < B; h++)
                        C = z[h], k = NaN, y = C.above, isNaN(C.toValue) ||
                            (k = this.getCoordinate(C.toValue), u =
                                new this.axisItemRenderer(this, k, "", !0, NaN, NaN, C), this.pushAxisItem(u, y)), l =
                                NaN, isNaN(C.value) ||
                            (l = this.getCoordinate(C.value), u =
                                new this.axisItemRenderer(this, l, C.label, !0, NaN, (k - l) / 2, C), this.pushAxisItem(
                                u,
                                y)), isNaN(k) && (l -= 3, k = l + 3),
                            u && (m = u.label) && this.addEventListeners(m, C),
                            isNaN(k - l) ||
                                0 > l && 0 > k ||
                                (k = new this.guideFillRenderer(this, l, k, C), this.pushAxisItem(k, y), y =
                                    k.graphics(), C.graphics = y, this.addEventListeners(y, C));
                    this.fillAlpha = D;
                }
                u = this.baseValue;
                this.min >
        ...
        formatValue: function(a, b, c) {
            ...
            if (f)
                return !0 === this.logarithmic && (e = -1 != String(a).indexOf("e") ? !0 : !1),
                    this.useScientificNotation && (e = !0), this.usePrefixes && (e = !1), e
                        ? (c = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), e = c.split("e"), c =
                                Number(e[0]), e = Number(e[1]), c =
                                d.roundTo(c, 14), b || isNaN(this.precision) || (c = d.roundTo(c, this.precision)),
                            10 == c && (c = 1, e += 1), c = c + "e" + e, 0 === a && (c = "0"), 1 == a && (c = "1"))
                        : (g &&
                        (e = String(a).split("."), e[1]
                            ? (f.precision = e[1].length, 0 > c && (f.precision = Math.abs(c)), b &&
                                1 < a &&
                                (f.precision = 0), b || isNaN(this.precision) || (f.precision = this.precision))
                            : f.precision = -1), c = this.usePrefixes
                            ? d.addPrefix(a, h.prefixesOfBigNumbers, h.prefixesOfSmallNumbers, f, !b)
                            : d.formatNumber(a, f, f.precision)), this.duration &&
                    (b && (f.precision = 0), c =
                    ...
                    this.recalculateToPercents
                        ? c += "%"
                        : (b = this.unit) && (c = "left" == this.unitPosition ? b + c : c + b), this.labelFunction &&
                    (c = "date" == this.type
        ...
        stackGraphs: function(a) {
            ...
            "100% stacked" == b && (b = "100%");
            this.stackType = b;
            var c = [], e = [], g = [], f = [], h, k = this.chart.graphs, l, m, p, q, n, t = this.baseValue, r = !1;
            if ("line" == a || "step" == a || "smoothedLine" == a) r = !0;
            if (r && ("regular" == b || "100%" == b))
                for (q = 0; q < k.length; q++)
                    p = k[q], p.stackGraph = null, p.hidden ||
                    (m = p.type, p.chart == this.chart &&
                        p.valueAxis == this &&
                        a == m &&
                        p.stackable &&
            ...
            for (n = p; n <= l; n++) {
                var w =
                    0;
                for (q = 0; q < k.length; q++)
                    if (p = k[q], p.hidden) p.newStack && (g[n] = NaN, e[n] = NaN);
                    else if (m = p.type, p.chart == this.chart && p.valueAxis == this && a == m && p.stackable)
                        if (m = this.data[n].axes[this.id].graphs[p.id], h =
                            m.values.value, isNaN(h)) p.newStack && (g[n] = NaN, e[n] = NaN);
                        else {
                            var z = d.getDecimals(h);
                            w < z && (w = z);
                            isNaN(f[n]) ? f[n] = Math.abs(h) : f[n] += Math.abs(h);
                            f[n] = d.roundTo(f[n], w);
                            z = p.fillToGraph;
                            ...
                            (r &&
                            (isNaN(c[n])
                                ? (c[n] = h, m.values.close =
                                    h, m.values.open = this.baseValue)
                                : (isNaN(h) ? m.values.close = c[n] : m.values.close = h + c[n], m.values.open =
                                    c[n], c[n] = m.values.close)), "column" == a &&
                            (p.newStack && (g[n] = NaN, e[n] = NaN), m.values.close = h, 0 > h
                                ? (m.values.close =
                                        h, isNaN(e[n])
                                        ? m.values.open = t
                                ...
                                : (m.values.close =
                                        h, isNaN(g[n])
                                        ? m.values.open = t
                                        : (m.values.close += g[n], m.values.open = g[n]),
                                    g[n] = m.values.close)));
                        }
            }
                ...
                for (q = 0; q < k.length; q++)
                    (p = k[q], p.hidden)
                        ...
                        : (m = p.type, p.chart == this.chart &&
                            ...
                            a == m &&
                            p.stackable &&
                            (m = this.data[n].axes[this.id].graphs[p.id], h = m.values.value, isNaN(h) ||
                            (c = h / f[n] * 100, m.values.percents = c, m.values.total =
                                f[n], p.newStack && (g[n] = NaN, e[n] = NaN), "100%" == b &&
                            (isNaN(e[n]) && (e[n] = 0), isNaN(g[n]) && (g[n] = 0), 0 > c
                                ? (m.values.close = d.fitToBounds(c + e[n], -100, 100), m.values.open = e[n], e[n] =
                                    m.values.close)
                                : (m.values.close = d.fitToBounds(c + g[n], -100, 100), m.values.open = g[n], g[n] =
                                    m.values.close)))));
        },
            ...
            for (c = 0; c < b.length; c++) {
                ...
                if (e.valueAxis == this) {
                    ...
                    if (!isNaN(a.startTime) && (m = a.categoryAxis)) {
                        ...
                        d.resetDateToMin(new Date(p), m.minPeriod).getTime() > q && h++;
                    }
                    if (m =
                        a.recalculateFromDate)
                        m = d.getDate(m, a.dataDateFormat, "fff"), h =
                            a.getClosestIndex(a.chartData, "time", m.getTime(), !0, 0, a.chartData.length), k =
                            a.chartData.length - 1;
                    for (m = h;
                        m <= k &&
                        (h = this.data[m].axes[this.id].graphs[e.id], f = h.values[g], e.recalculateValue &&
                            (f = h.dataContext[e.valueField + e.recalculateValue]), isNaN(f));
                        m++);
                    this.recBaseValue = f;
                    for (g = l; g <= k; g++) {
                        ...
                        h.percents = {};
                        var l = h.values, n;
                        for (n in l) h.percents[n] = "percents" != n ? l[n] / f * 100 - 100 : l[n];
                    }
                }
            }
        },
        getMinMax: function() {
            ...
            (this.step =
                this.setStep);
            1 > c
                ? (this.maxDecCount = Math.abs(Math.log(Math.abs(c)) * Math.LOG10E), this.maxDecCount =
                    Math.round(this.maxDecCount), this.step = d.roundTo(this.step, this.maxDecCount + 1))
                : this.maxDecCount = 0;
            ...
            (2 < Math.log(b) * Math.LOG10E - Math.log(a) * Math.LOG10E
                ? (this.minReal = this.min =
                    Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.maxReal =
                    this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E)))
                : (a = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10, Math.pow(10,
                        Math.floor(Math.log(Math.abs(this.min)) *
                            Math.LOG10E)) /
                    10 <
                    a &&
        ...
        zoomToRelativeValues: function(a, b, c) {
            ...
            this.logarithmic &&
            (isNaN(this.minimum) || (e = this.minimum), isNaN(this.maximum) || (d = this.maximum), d =
                Math.log(d) * Math.LOG10E - Math.log(e) * Math.LOG10E, f = Math.pow(10,
                d * a +
                Math.log(e) * Math.LOG10E), h = Math.pow(10, d * b + Math.log(e) * Math.LOG10E));
        ...
        zoomToValues: function(a, b, c) {
            ...
            if (this.minZoom != a || this.maxZoom != b)
                return this.minZoom = a, this.maxZoom = b, e = { type: "axisZoomed" }, e.chart =
                        this.chart, e.valueAxis = this, e.startValue = a, e.endValue = b, e.relativeStart =
                        this.relativeStart, e.relativeEnd =
                        this.relativeEnd, this.prevStartValue == a && this.prevEndValue == b || this.fire(e),
                    this.prevStartValue = a, this.prevEndValue =
                        b, c || (a = {}, d.copyProperties(e, a), a.type = "axisIntZoomed", this.fire(a)), 0 ===
                        this.relativeStart &&
                        1 == this.relativeEnd &&
        ...
        getCoordinate: function(a, b) {
            ...
            var c = this.rotate,
                ...
                k = this.minReal;
            !0 === this.logarithmic
                ? (0 === a && (a = this.treatZeroAs), h = Math.log(a) * Math.LOG10E - Math.log(k) * Math.LOG10E, c =
                    c ? !0 === e ? d - f * h : f * h : !0 === e ? f * h : d - f * h)
            ...
            if (this.synchronizeWith) {
                ...
                (this.min = b * e, this.max = c * e, this.step = a * e, b =
                    Math.abs(Math.log(Math.abs(Math.pow(10, Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)))) *
                        Math.LOG10E), this.maxDecCount = b = Math.round(b), this.draw());
            }
        }
    });
})();
    ...
    d.RecAxis = d.Class({
        construct: function(a) {
            var b = a.chart,
                ...
                n = b.container;
            "H" == a.orientation
                ? (e = d.line(n, [0, q], [0, 0], e, g, c), this.axisWidth =
                    a.width, "bottom" == a.position
                    ? (k = c / 2 + f + p + m - 1, c = l)
                    : (k = -c / 2 - f + m + k, c = h + l))
                : (this.axisWidth = a.height, "right" == a.position
                    ? (e = d.line(n, [0, 0, -h], [0, p, p - k], e, g, c), k = m + k, c = c / 2 + f + h + q + l - 1)
                    : (e = d.line(n, [0, 0], [0, p], e, g, c), k = m, c = -c / 2 - f + l));
            e.translate(c,
                k);
            c = b.container.set();
            c.push(e);
...
(function() {
    var d = window.AmCharts;
    d.RecItem = d.Class({
        construct: function(a, b, c, e, g, f, h, k, l, m, p, q) {
            b = Math.round(b);
            var n = a.chart;
            this.value = c;
            void 0 == c && (c = "");
            ...
            var ia = a.counter,
                ...
                Ba;
            h
                ? (void 0 !== h.id && (q = n.classNamePrefix + "-guide-" + h.id), P =
                        !0, isNaN(h.tickLength) || (B = h.tickLength), void 0 != h.lineColor && (K = h.lineColor),
                    void 0 != h.color && (w = h.color), isNaN(h.lineAlpha) || (D = h.lineAlpha),
                    isNaN(h.dashLength) || (H = h.dashLength), isNaN(h.lineThickness) || (C = h.lineThickness),
                    !0 === h.inside && (I = !0, 0 < ea && (ea = 0)), isNaN(h.labelRotation) ||
                        (p = h.labelRotation), isNaN(h.fontSize) || (r = h.fontSize), h.position && (Z = h.position),
                    void 0 !== h.boldLabel && (k = h.boldLabel), isNaN(h.labelOffset) || (aa = h.labelOffset))
                : "" === c && (B = 0);
            ...
            P &&
                ...
                (ca = a.autoWrap && 0 === p
                    ...
                    : d.text(z, c, w, t, r, ga, k), ga = ca.getBBox(), ha = ga.width, Qa = ga.height);
            if ("H" == Pa) {
                if (0 <= b &&
                        b <= xa + 1 &&
                        (0 < B &&
                            ...
                            0 < D && (Ba = d.line(z, [b, b + ma, b + ma], [X, X + na, na], K, D, C, H), x.push(Ba))),
                    v =
                        0, G = b, h && 90 == p && I && (G -= r), !1 === e
                        ? (ga = "start", v =
                            "bottom" == Z ? I ? v + B : v - B : I ? v - B : v + B, G += 3, 0 < g &&
                            (G += g / 2 - 3, ga = "middle"), 0 < p && (ga = "middle"))
                        : ga = "middle", 1 == ia &&
                        0 < M &&
                        !h &&
                        !m &&
                        da < xa &&
                        (e = d.fitToBounds(b, 0, xa), da = d.fitToBounds(da, 0, xa), Y = e - da, 0 < Y &&
                            (Da = d.rect(z, Y, a.height, Q, M), Da.translate(e - Y + ma, na), x.push(Da))), "bottom" ==
                        Z
                        ? (v += X + r / 2 + ea, I
                            ? (0 < p
                                ? (v =
                                        X - ha / 2 * Math.sin(V) - B - 3,
                            ...
                            : (0 < p
                                ? (v =
                                    X + ha / 2 * Math.sin(V) + B + 3, a.centerRotatedLabels ||
                                    (G -= ha / 2 * Math.cos(V)))
                                : 0 > p
                        ...
                        : (v += na + r / 2 - ea, G += ma, I
                            ? (0 < p
                                ? (v = ha / 2 * Math.sin(V) + B + 3, a.centerRotatedLabels ||
                                    (G -= ha / 2 * Math.cos(V)))
                                : v += B + 3, v += aa)
                            : (0 < p
                                ? (v =
                                    -(ha / 2) * Math.sin(V) - B - 6, a.centerRotatedLabels ||
                                    (G += ha / 2 * Math.cos(V)))
                                : v -= B +
                                r +
                                3 +
                    ...
                    f && (G += f), r =
                        G, 0 < p && (r += ha / 2 * Math.cos(V)), ca &&
                        (f = 0, I && (f = ha / 2 * Math.cos(V)), r + f > xa + 2 || 0 > r)) ca.remove(), ca = null;
            } else {
                0 <= b &&
                    b <= X + 1 &&
                    (0 < B &&
                        0 < y &&
                        b + l <= X + 1 &&
                        (fa = d.line(z, [0, B + 1], [b + l, b + l], A, y, C), x.push(fa)), 0 < D &&
                        (Ba = d.line(z, [0, ma, xa + ma], [b, b + na, b + na], K, D, C, H), x.push(Ba)));
                ga = "end";
                ...
                1 == ia &&
                    ...
                    !h &&
                    !m &&
                    (e = d.fitToBounds(b, 0, X), da = d.fitToBounds(da, 0, X), V = e - da, Da = d.polygon(z,
                        [0, a.width, a.width, 0],
                        [0, 0, V, V],
                        Q,
                        M), Da.translate(ma, e - V + na), x.push(Da));
                v += r / 2;
                "right" == Z
                    ? (G += ma + xa + ea, v += na, I
            ...
            fa &&
            (fa.translate(oa, Y), d.setCN(n, fa, a.bcn + "tick"), d.setCN(n, fa, q, !0), h &&
                d.setCN(n, fa, "guide"));
            !1 ===
                a.visible &&
                (fa && fa.remove(), ca && (ca.remove(), ca = null));
            ca &&
            (ca.attr({ "text-anchor": ga }), ca.translate(G, v, NaN, !0),
                0 !== p && ca.rotate(-p, a.chart.backgroundColor), a.allLabels.push(ca), this.label =
                    ca, d.setCN(n, ca, a.bcn + "label"), d.setCN(n, ca, q, !0), h && d.setCN(n, ca, "guide"));
            Ba && (d.setCN(n, Ba, a.bcn + "grid"), d.setCN(n, Ba, q, !0), h && d.setCN(n, Ba, "guide"));
...
(function() {
    ...
    d.RecFill = d.Class({
        construct: function(a, b, c, e) {
            ...
            "V" == h
                ? (h = d.rect(l, a.width, c, p, m), h.translate(g, b - k + f))
                : (h = d.rect(l,
                    c,
                    a.height,
                    p,
...
(function() {
    ...
    d.AmChart = d.Class({
        construct: function(a) {
            ...
            this.version = "3.21.1";
            d.addChart(this);
            this.createEvents("buildStarted",
                "dataUpdated",
                "init",
                "rendered",
                "drawn",
        ...
        write: function(a) {
            ...
            0 < b.processTimeout
                ? b.afterWriteTO = setTimeout(function() { b.afterWrite.call(b, a) }, b.processTimeout)
                : b.afterWrite(a);
        },
        afterWrite: function(a) {
            ...
            if (b = "object" != typeof a ? document.getElementById(a) : a) {
                ...
                (b = this.exportConfig) &&
                    d.AmExport &&
                    !this.AmExport &&
                    (this.AmExport = new d.AmExport(this,
                        b));
                ...
                if (e) {
                    ...
                    if (e.enabled)
                        switch (g.left = null, g.top = null, g.right = null, f.left = null, f.right = null, f.top =
                            null, g.position = "relative", f.position = "relative", h.width = "100%", h.height =
                            "100%", e.position) {
                        case "bottom":
                            k.appendChild(a);
                            k.appendChild(c);
        ...
        initChart: function() {
            ...
            d.VML || d.SVG
                ? (a.handDrawn = this.handDrawn, a.handDrawScatter = this.handDrawScatter, a.handDrawThickness =
                        this.handDrawThickness, d.remove(this.set), this.set =
                        a.set(), d.remove(this.gridSet), this.gridSet =
                        a.set(), d.remove(this.cursorLineSet), this.cursorLineSet =
                        a.set(), d.remove(this.graphsBehindSet), this.graphsBehindSet =
                        a.set(), d.remove(this.bulletBehindSet),
                    this.bulletBehindSet = a.set(), d.remove(this.columnSet), this.columnSet =
                        a.set(), d.remove(this.graphsSet), this.graphsSet =
                        a.set(), d.remove(this.trendLinesSet), this.trendLinesSet =
                        a.set(), d.remove(this.axesSet), this.axesSet =
                        a.set(), d.remove(this.cursorSet), this.cursorSet =
                        a.set(), d.remove(this.scrollbarsSet), this.scrollbarsSet =
                        a.set(), d.remove(this.bulletSet), this.bulletSet =
                        a.set(), d.remove(this.freeLabelsSet), this.freeLabelsSet =
                        a.set(), d.remove(this.axesLabelsSet), this.axesLabelsSet = a.set(), d.remove(this.balloonsSet),
                    this.balloonsSet = a.set(), d.remove(this.plotBalloonsSet), this.plotBalloonsSet =
                        a.set(), d.remove(this.zoomButtonSet), this.zoomButtonSet =
                        a.set(), d.remove(this.zbSet), this.zbSet = null, d.remove(this.linkSet), this.linkSet =
                        a.set())
            ...
            if (a) {
                ...
                (c != this.previousWidth || e != this.previousHeight) &&
                    ...
                    (b.style.width = a + "px", b.style.height = f + "px", b.style.padding =
                        0, g && g.setSize(a, f), this.balloon = d.processObject(this.balloon, d.AmBalloon, this.theme));
        ...
        checkTransform: function(a) {
            if (this.autoTransform &&
                ...
                if (a.style) {
                    ...
                    if (b &&
                        (b = b.getPropertyValue("-webkit-transform") ||
        ...
        drawLabel: function(a) {
            ...
            if (b.container && !1 !== a.enabled) {
                ...
                "left" == g && (g = "start");
                "right" == g && (g = "end");
                "center" == g && (g = "middle", k ? c = b.realHeight - c + c / 2 : p = b.realWidth / 2 - p);
                void 0 === l && (l = 1);
                void 0 === k && (k = 0);
                c += f / 2;
                ...
                0 !== k && e.rotate(k);
                a.url
                    ? (e.setAttr("cursor", "pointer"), e.click(function() { d.getURL(a.url, b.urlTarget) }))
            ...
            document.addEventListener
                ? ("ontouchstart" in document.documentElement &&
                    (b.addEventListener("touchstart",
                            function(b) { a.handleTouchStart.call(a, b) },
                            !0), b.addEventListener("touchmove", function(b) { a.handleMouseMove.call(a, b) }, !0),
                        b.addEventListener("touchend", function(b) { a.handleTouchEnd.call(a, b) }, !0), a.docfn1 =
                            function(b) { a.handleDocTouchStart.call(a, b) }, a.docfn2 =
                            function(b) { a.handleDocTouchEnd.call(a, b) }, document.addEventListener("touchstart",
                            a.docfn1,
                            !0), document.addEventListener("touchend", a.docfn2, !0)), b.addEventListener("mousedown",
                        function(b) {
                            a.mouseIsOver = !0;
                    ...
                    b.addEventListener("mouseup", function(b) { a.handleDocTouchEnd.call(a, b) }, !0))
                : (b.attachEvent("onmousedown", function(b) { a.handleMouseDown.call(a, b) }), b.attachEvent(
                    "onmouseover",
                    function(b) { a.handleMouseOver.call(a, b) }), b.attachEvent("onmouseout",
                    function(b) { a.handleMouseOut.call(a, b) }));
        },
        dispDUpd: function() {
            this.skipEvents ||
            (this.dispatchDataUpdated &&
                (this.dispatchDataUpdated = !1, this.fire({ type: "dataUpdated", chart: this })), this.chartCreated ||
                (this.chartCreated = !0, this.fire({ type: "init", chart: this })), this.chartRendered ||
                (this.fire({ type: "rendered", chart: this }), this.chartRendered = !0), this.fire({
                type: "drawn",
                chart: this
            }));
            this.skipEvents = !1;
            ...
            if (this.animations)
                for (a = this.animations.length - 1; 0 <= a; a--) {
                    ...
                    if (e <= c) {
                        ...
                        g.node.style[f] = Number(b.to) + b.suffix, g.animationFinished =
                            !0, this.animations.splice(a, 1);
                }
        },
        update: function() {
    ...
    d.AmGraph = d.Class({
        ...
        draw: function() {
            ...
            if (a.drawGraphs) {
                ...
                g ||
                (f = this.valueAxis.stackType, g =
                    "top", "column" == this.type &&
                    (a.rotate && (g = "right"), "100%" == f || "regular" == f) &&
                    (g = "middle"), this.labelPosition = g);
                d.ifArray(this.data) &&
                (a = !1, "xy" == b
        ...
        positionLabel: function(a, b, c, e, d) {
            if (e) {
                ...
                case "right":
                    ...
                    break;
                case "top":
                    c = h.reversed ? c + (d / 2 + p.height / 2 + z) : c - (d / 2 + p.height / 2 + z);
                    break;
                case "bottom":
                    c = h.reversed ? c - (d / 2 + p.height / 2 + z) : c + (d / 2 + p.height / 2 + z);
                    break;
        ...
        createSerialGraph: function() {
            ...
            if (!(I ||
                ...
                (1 == e.length &&
                    "step" != h &&
                    "none" == this.bullet &&
                    (this.bullet = "round", this.resetBullet = !0), !Ra && void 0 == Ja || m))) {
                var Ua = Pa;
                Ua > f.max && (Ua = f.max);
                Ua < f.min && (Ua = f.min);
                ...
                t
                    ? (ha = q, Qa = Math.abs(Mb - Ka), ub = q, vb = Math.abs(ib - Ka), hb = tb =
                        0, f.reversed ? (ca = 0, gb = Ka) : (ca = Ka, gb = 0))
                    : (Qa = p, ha = Math.abs(Mb - Ka), vb = p, ub = Math.abs(ib - Ka), gb = ca =
                        0, f.reversed ? (hb = n, tb = Ka) : hb = Ka);
            }
            var La = Math.round;
            this.pmx = La(ca);
            this.pmy = La(tb);
            ...
            for (L = P; L <= ia; L++) {
                ...
                if (Ia) {
                    ...
                    "start" == this.pointPosition &&
                        (ja -= Y / 2 + Math.floor(Wa * Y / 2), wa = 0, Ga = Math.floor(Y) + Math.floor(Wa * Y));
                    "end" == this.pointPosition &&
                        (ja += Y / 2 + Math.floor(Wa * Y / 2), wa = Math.floor(Y) + Math.floor(Wa * Y), Ga = 0);
                    if (Ob) {
                    ...
                    case "line":
                        if (isNaN(W))
                            ...
                            if ($a ||
                                ...
                                !isNaN(v.dashLength))
                                this.drawLineGraph(x, u, T, U), x = [E], u = [F], T = [], U =
                                    [], !Ma || isNaN(N) || isNaN(O) || (T.push(O), U.push(N)), m
                                    ? (Sa
                                        ? (this.lineColorSwitched = xa, this.fillColorsSwitched = wb)
                                        : (this.lineColorSwitched =
                                            Ja, this.fillColorsSwitched = Ra), void 0 === this.bulletColor &&
                                        (this.bulletColorSwitched = xa))
                                    : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched =
                                        v.fillColors, void 0 === this.bulletColor &&
                                        (this.bulletColorSwitched = this.lineColorSwitched)), this.dashLengthSwitched =
                                    v.dashLength;
                    ...
                    case "smoothedLine":
                        if (isNaN(W)) z || (this.drawSmoothedGraph(x, u, T, U), x = [], u = [], T = [], U = []);
                            ...
                            (this.drawSmoothedGraph(x, u, T, U), x = [E], u = [F], T = [], U =
                                [], !Ma || isNaN(N) || isNaN(O) || (T.push(O), U.push(N)), this.lineColorSwitched =
                                v.lineColor, this.fillColorsSwitched = v.fillColors, this.dashLengthSwitched =
                                v.dashLength);
                    ...
                    case "step":
                        if (!isNaN(W)) {
                            t
                                ? (isNaN(A) || (x.push(A), u.push(F - wa)), u.push(F - wa), x.push(E),
                                    u.push(F + Ga), x.push(E), !Ma ||
                                        isNaN(N) ||
                                        isNaN(O) ||
                                        (isNaN(B) || (T.push(B), U.push(N - wa)), T.push(O), U.push(N - wa), T.push(O),
                                            U.push(N + Ga)))
                                : (isNaN(y) || (u.push(y), x.push(E - wa)), x.push(E - wa), u.push(F), x.push(E + Ga),
                                    u.push(F), !Ma ||
                                        isNaN(N) ||
                                        isNaN(O) ||
                                        (isNaN(D) || (T.push(O - wa), U.push(D)), T.push(O - wa), U.push(N), T.push(
                                            O + Ga), U.push(N)));
                            A = E;
                            y = F;
                            B = O;
                    ...
                    case "column":
                        ...
                        if (!isNaN(W)) {
                            ...
                            if (!(W < Qb && ob < Qb || W > Rb && ob > Rb)) {
                                ...
                                if (t) {
                                    "3d" == M
                                        ? (R = F - (r / 2 - this.depthCount + 1) * (k + V) + V / 2 + Q * Z, S =
                                            O + H * Z, Aa = Z)
                                    ...
                                    isNaN(G.percentWidthValue) ||
                                        (J = this.height * G.percentWidthValue / 100, R = ja - J / 2, Ea = R + J / 2);
                                    J = d.roundTo(J, 2);
                                    ba = d.roundTo(ba, 2);
                                    R < q &&
                                        0 < J &&
                                        (va = new d.Cuboid(g,
                                            ...
                                            bb,
                                            mb,
                                            aa), v.columnWidth = Math.abs(ba), v.columnHeight = Math.abs(J));
                                } else {
                                    "3d" == M
                                        ? (S = E - (r / 2 - this.depthCount + 1) * (k + V) + V / 2 + H * Z, R =
                                            N + Q * Z, Aa = Z)
                                    ...
                                    isNaN(G.percentWidthValue) ||
                                        (J = this.width * G.percentWidthValue / 100, S = ja - J / 2, ya = S + J / 2);
                                    J = d.roundTo(J, 2);
                                    ba = d.roundTo(ba, 2);
                                    S < p + Z * H &&
                                        0 < J &&
                                        (this.showOnAxis && (R -= Q / 2), va = new d.Cuboid(g,
                                            J,
                                            ba,
                                            H - a.d3x,
                                            Q - a.d3y,
                            ...
                            if (va) {
                                ...
                                if (!I) {
                                    ...
                                    (t
                                        ? (K =
                                            (this.end + 1 - L) * C - c - 1E3 * this.depthCount, ya += H * Z, ka +=
                                            H * Z, v.y += H * Z)
                                        : (K =
                                            (C - c) * (L + 1) + 1E3 * this.depthCount, Ea += Q * Z, la += Q * Z, v.y +=
                                            Q * Z));
                                    if ("regular" == M || "100%" == M)
                                        K = t
                                            ? 0 < Ia.value
                            ...
                            if (t) {
                                ...
                                if (R < q && 0 < J) {
                                    ...
                                    !isNaN(sa) &&
                                        ...
                                        F < q &&
                                        0 < F &&
                                        (Xa = d.line(g, Eb, [F, F], Ca, X, da), cb = d.line(g, Fb, [F, F], Ca, X, da));
                                    ba = E - O;
                                ...
                                if (S < p && 0 < J) {
                                    ...
                                    !isNaN(ta) &&
                                        ...
                                        E < p &&
                                        0 < E &&
                                        (Xa = d.line(g, [E, E], Gb, Ca, X, da), cb = d.line(g,
                                                [E, E],
                                                Hb,
                                                Ca,
                                                X,
                                                da), d.setCN(a, Xa, this.bcn + "line-high"), v.className &&
                                                d.setCN(a, Xa, v.className, !0), d.setCN(a, cb, this.bcn + "line-low"),
                                            v.className && d.setCN(a, cb, v.className, !0));
                                }
                            }
                            va &&
                            (za = va.set, v.columnGraphics =
                                    za, fa.push(za), za.translate(S, R - da / 2),
                                (v.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"),
                                Xa && (fa.push(Xa), fa.push(cb)), I ||
                                (v.x =
                                        t ? R + J / 2 : S + J / 2, this.animateColumns(va, L, E, O, F, N),
                                    this.addListeners(za, v), void 0 !== this.tabIndex &&
                    ...
                    case "ohlc":
                        if (!(isNaN(ua) ||
                            ...
                            if (t) {
                                ...
                                0 < E && E < p && (pb = d.line(g, [E, E], [ra, ta], Ha, X, da, ea));
                            ...
                            if ("regular" == M || "100%" == M) {
                                ...
                                if (Zb) {
                                    ...
                                    if (Oa) {
                                        ...
                                        t
                                            ? (eb = Ea, db =
                                                0 > W ? E - ac / 2 - 2 - fb - sb : E + ac / 2 + 3 + fb + sb)
            ...
            this.lastDataItem = v;
            if ("line" == h || "step" == h || "smoothedLine" == h)
                "smoothedLine" == h ? this.drawSmoothedGraph(x, u, T, U) : this.drawLineGraph(x, u, T, U), I ||
                    this.launchAnimation();
        ...
        animateColumns: function(a, b) {
            ...
            0 < e &&
                !c.animationPlayed &&
                (c.seqAn
                    ? (a.set.hide(), c.animationArray.push(a), e =
                            setTimeout(function() { c.animate.call(c) },
                                e / (c.end - c.start + 1) * (b - c.start) * 1E3),
                        c.timeOuts.push(e))
                    : c.animate(a), c.chart.animatable.push(a));
        },
        createLabel: function(a, b, c) {
            ...
            f && (b = f(a, b));
            if (void 0 !== b && "" !== b)
                return a = d.text(this.container, b, g, e.fontFamily, c), a.node.style.pointerEvents =
        ...
        drawLineGraph: function(a, b, c, e) {
            var g = this;
            if (1 < a.length) {
                var f = g.noRounding, h = g.set, k = g.chart, l = g.container, m = l.set(), p = l.set();
                h.push(p);
                h.push(m);
                var q = g.lineAlpha, n = g.lineThickness, h = g.fillAlphas, t = g.lineColorR, r = g.negativeLineAlpha;
                isNaN(r) && (r = q);
                ...
                0 !== g.negativeBase &&
                (y = g.valueAxis.getCoordinate(g.negativeBase,
                ...
                m.push(q);
                m.click(function(a) { g.handleGraphEvent(a, "clickGraph") })
                    .mouseover(function(a) { g.handleGraphEvent(a, "rollOverGraph") })
                    .mouseout(function(a) { g.handleGraphEvent(a, "rollOutGraph") })
                    .touchmove(function(a) { g.chart.handleMouseMove(a) })
                    .touchend(function(a) { g.chart.handleTouchEnd(a) });
                void 0 === z ||
                    ...
                    (n = d.line(l,
                        ...
                        !1,
                        !0,
                        f), n.node.setAttribute("stroke-linejoin", "round"), d.setCN(k, n, g.bcn + "stroke"), d.setCN(k,
                        n,
                        g.bcn + "stroke-negative"), p.push(n));
                if (0 < h || 0 < A)
                    if (n = a.join(";").split(";"), r = b.join(";").split(";"), q =
                        k.type, "serial" == q || "radar" == q
                        ? 0 < c.length
                        ...
                        (d.isString(b) && (b = k.getValueAxisById(b)), "H" == b.orientation
                            ? (y =
                                    "top" == b.position ? 0 : b.height, n.push(n[n.length - 1]), r.push(y),
                                n.push(n[0]),
                                r.push(y), n.push(a[0]), r.push(r[0]))
                            : (y =
                                    "left" == b.position ? 0 : b.width, r.push(r[r.length - 1]), n.push(y),
                                r.push(r[0]),
                                n.push(y), r.push(r[0]), n.push(n[0]))), a =
                        g.gradientRotation, 0 < h &&
                    (b = d.polygon(l, n, r, w, h, 1, "#000", 0, a, f), b.pattern(g.pattern, NaN, k.path), d.setCN(k,
                        b,
                        g.bcn + "fill"), m.push(b)), u || void 0 !== z)
                        isNaN(A) && (A = h), u || (u = z), f = d.polygon(l,
                                n,
                                r,
                                u,
                                A,
                                ...
                                0,
                                a,
                                f), d.setCN(k, f, g.bcn + "fill"), d.setCN(k, f, g.bcn + "fill-negative"),
                            f.pattern(g.pattern, NaN, k.path), p.push(f), p
                                .click(function(a) { g.handleGraphEvent(a, "clickGraph") })
                                .mouseover(function(a) { g.handleGraphEvent(a, "rollOverGraph") })
                                .mouseout(function(a) { g.handleGraphEvent(a, "rollOutGraph") })
                                .touchmove(function(a) { g.chart.handleMouseMove(a) }).touchend(function(a) {
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                m = new d.Bezier(h, a, b, n, m, p, t, 0, g, void 0, u);
                d.setCN(f, m, this.bcn + "stroke");
                k.push(m.path);
                void 0 !== r &&
                (p = new d.Bezier(h, a, b, r, A, p, t, 0, g, void 0, u), d.setCN(f, p, this.bcn + "stroke"),
                    d.setCN(f, p, this.bcn + "stroke-negative"), l.push(p.path));
                0 < q &&
                    (p = a.join(";").split(";"), m = b.join(";").split(";"), n = "", 0 < c.length
                            ...
                            : (this.rotate
                                ...
                                : (n += " L" +
                                    a[a.length - 1] +
                                    "," +
                                    x, n += " L" + a[0] + "," + x), n += " L" + a[0] + "," + b[0]), a =
                            new d.Bezier(h, p, m, NaN, 0, 0, t, q, g, n, u), d.setCN(f, a, this.bcn + "fill"),
                        a.path.pattern(this.pattern, NaN, f.path), k.push(a.path), w || void 0 !== r) &&
                    (z || (z = q), w || (w = r), h =
                            new d.Bezier(h, p, m, NaN, 0, 0, w, z, g, n, u), h.path.pattern(this.pattern, NaN, f.path),
                        d.setCN(f, h, this.bcn + "fill"), d.setCN(f, h, this.bcn + "fill-negative"), l.push(h.path));
                this.applyMask(l, k);
            }
        },
        ...
        animateGraphs: function() {
            ...
            (this.rotate ? (b.translate(-1E3, d), c.translate(-1E3, d)) : (b.translate(e, -1E3), c.translate(e, -1E3)),
                b.animate({ opacity: 1, translate: e + "," + d }, f, h), c.animate({
                        opacity: 1,
                        translate: e + "," + d
                    },
                    f,
                    h), a.animatable.push(b));
        },
        animate: function(a) {
        ...
        createBullet: function(a, b, c) {
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                isNaN(l) || (isNaN(k) || (h = (k - m) / (l - m) * (p - q) + q), m == l && (h = p));
                l = h;
                this.bulletAxis &&
                (h = a.values.error,
                ...
                (m = this.lineColorR, a.isNegative && this.negativeLineColor && (m = this.negativeLineColor),
                    this.lineColorSwitched && (m = this.lineColorSwitched));
                var r = a.alpha;
                isNaN(r) || (t = r);
                n = d.bullet(g, f, h, q, t, k, m, p, l, 0, n, e.path);
                l = this.customBullet;
                a.customBullet && (l = a.customBullet);
                l &&
                (n && n.remove(), "function" == typeof l
                    ? (l = new l, l.chart = e, a.bulletConfig &&
                        (l.availableSpace = c, l.graph = this, l.graphDataItem = a, l.bulletY =
                            c, a.bulletConfig.minCoord = this.minCoord - c, l.bulletConfig =
                            a.bulletConfig), l.write(g),
                        n && l.showBullet && l.set.push(n), a.customBulletGraphics = l.cset, n = l.set)
                    : (n = g.set(), l =
                        g.image(l, 0, 0, h, h), n.push(l), this.centerCustomBullets && l.translate(-h / 2, -h / 2)));
                if (n) {
                    (a.url || this.showHandOnHover) && n.setAttr("cursor", "pointer");
                    if ("serial" == e.type || "gantt" == e.type)
                        if (-.5 > b || b > this.width || c < -h / 2 || c > this.height) n.remove(), n = null;
                    n &&
                ...
                if (n) {
                    ...
                    if (e = this.bulletHitAreaSize)
                        g = d.circle(g, e, "#FFFFFF", .001, 0), g.translate(b, c), a.hitBullet =
                            g, this.bulletSet.push(g), this.addListeners(g, a);
                    a.bulletGraphics = n;
        ...
        addListeners: function(a, b) {
            var c = this;
            a.mouseover(function(a) { c.handleRollOver(b, a) }).mouseout(function(a) { c.handleRollOut(b, a) })
                .touchend(function(a) {
        ...
        showGraphBalloon: function(a, b, c, e, g) {
            if (a) {
                var f = this.chart, h = this.balloon, k = 0, l = 0, m = f.chartCursor, p = !0;
                m
                    ? m.valueBalloonsEnabled || (h = f.balloon, k = this.x, l = this.y, p = !1)
                    : (h = f.balloon, k = this.x, l = this.y, p = !1);
                ...
                if (h && h.enabled && this.showBalloon && !this.hidden) {
                    ...
                    m && "" !== m
                        ? (e = f.getBalloonColor(this, a), h.drop || (h.pointerOrientation = b), b = a.x, g =
                            a.y, f.rotate && (b = a.y, g = a.x), b += k, g += l, isNaN(b) || isNaN(g)
                            ? this.hideBalloonReal()
                            : (a = this.width, q =
                                    this.height, p && h.setBounds(k, l, a + k, q + l), h.changeColor(e), h.setPosition(
                                    b,
                                    g),
                                h.fixPrevious(), h.fixedPosition && (c = !1), !c &&
                                    "radar" != f.type &&
                                    (b < k || b > a + k || g < l - .5 || g > q + l)
        ...
        resizeBullet: function(a, b, c) {
            ...
            if (a && d.isModern && (1 != b || !isNaN(c))) {
                ...
                e &&
                    !e.doNotScale &&
                    (e.translate(a.bx, a.by, b), isNaN(c) ||
                        (e.setAttr("fill-opacity", c), e.setAttr("stroke-opacity", c)), this.resizedDItem = a);
            }
        }
    });
})();
(function() {
    ...
    d.ChartCursor = d.Class({
        ...
        draw: function() {
            ...
            (this.limitToGraph = d.getObjById(a.graphs, this.limitToGraph), this.fullWidth =
        ...
        createElements: function() {
            ...
            void 0 !== a.tabIndex &&
            (b.setAttr("tabindex", a.tabIndex), b.keyup(function(b) { a.handleKeys(b) })
                .focus(function(b) { a.showCursor() }).blur(function(b) { a.hideCursor() }));
        ...
        handleKeys: function(a) {
            ...
            if (c) {
                var e = c.chartData;
                e &&
                (isNaN(b) && (b = e.length - 1), 37 != a.keyCode && 40 != a.keyCode || b--,
                    39 != a.keyCode && 38 != a.keyCode || b++, b =
                        d.fitToBounds(b, c.startIndex, c.endIndex), (a = this.chart.chartData[b]) &&
                        this.setPosition(a.x.categoryAxis), this.prevIndex = b);
            }
        },
        update: function() {
            var a = this.chart;
            if (a) {
                ...
                if (a.chartData && 0 < a.chartData.length) {
                    this.mouseIsOver()
                        ? (this.hideGraphBalloons = !1, this.rolledOver = e =
                                !0, this.updateDrawing(),
                            this.vvLine &&
                                isNaN(this.fx) &&
                                (a.rotate || !this.limitToGraph) &&
                                this.vvLine.translate(b, 0), !this.hhLine ||
                                !isNaN(this.fy) ||
                                a.rotate && this.limitToGraph ||
                                this.hhLine.translate(0, c), isNaN(this.mouse2X)
        ...
        updateDrawing: function() {
            ...
            if (this.drawingNow &&
            (d.remove(this.drawingLine), 1 < Math.abs(this.drawStartX - this.mouseX) ||
        ...
        fixVLine: function(a, b) {
            if (!isNaN(a)) {
                ...
                (c = this.animationDuration,
                    this.zooming && (c = 0), this.vvLine.stop(), this.vvLine.animate({ translate: a + "," + b },
                        c,
                        "easeOutSine"), this.prevLineX = a, this.prevLineY = b);
            }
        },
        fixHLine: function(a, b) {
            if (!isNaN(a)) {
                ...
                this.prevLineY != a &&
                (c = this.animationDuration,
                    this.zooming && (c = 0), this.hhLine.stop(), this.hhLine.animate({ translate: b + "," + a },
                        c,
                        "easeOutSine"), this.prevLineY = a, this.prevLineX = b);
            }
        },
        hideCursor: function(a) {
            ...
            this.chart.wasTouched && this.leaveAfterTouch ||
                ...
                (this.hideCursorReal(), a
                    ...
                    : this.fire({ target: this, chart: this.chart, type: "onHideCursor" }), this.chart.setMouseCursor(
                    "auto"));
        },
        ...
        showCursor: function(a) {
            !this.drawing &&
                ...
                (this.vLineEnabled && this.vvLine && this.vvLine.show(),
                    this.hLineEnabled && this.hhLine && this.hhLine.show(), this.isHidden =
                        !1, this.updateFullLine(), a ||
                        this.fire({ target: this, chart: this.chart, type: "onShowCursor" }), this.pan &&
        ...
        updateSelection: function() {
            if (!this.pan && this.enabled) {
                ...
                isNaN(this.mouse2X) &&
                    ...
                    0 < Math.abs(f) &&
                    (a = this.chart, b =
                            d.rect(this.container, g, f, this.cursorColor, this.selectionAlpha),
                        d.setCN(a, b, "cursor-selection"), b.width = g, b.height =
        ...
        handleMouseDown: function() {
            this.update();
            if (this.mouseIsOver())
                if (this.mouseIsDown = !0, this.mouseX0 = this.mouseX, this.mouseY0 = this.mouseY, this.mouse2X0 =
                    this.mouse2X, this.mouse2Y0 = this.mouse2Y, this.drawing)
                    this.drawStartY = this.mouseY, this.drawStartX = this.mouseX, this.drawingNow = !0;
                else if (this.dispatchMovedEvent(this.mouseX, this.mouseY), !this.pan &&
                    isNaN(this.mouse2X0) &&
                    (isNaN(this.fx) ||
                    (this.mouseX0 =
            ...
            if (!this.pan) {
                ...
                if (b &&
                    ...
                    l &&
                        l.parseDates &&
                        !l.equalSpacing &&
                        (d = k[c] ? k[c].time : Math.min(this.timestamp0, this.timestamp), f =
                            k[e] ? h.getEndTime(k[e].time) : Math.max(this.timestamp0, this.timestamp));
                    var b = {
                            type: a,
                            chart: this.chart,
                            target: this,
        ...
        setIndex: function(a, b) {
            ...
            (this.index = a, b ||
                this.isHidden ||
                this.dispatchMovedEvent(this.mouseX,
                    this.mouseY,
                    "changed"));
        },
        handleMouseOut: function() {
            this.enabled &&
                this.rolledOver &&
                (this.leaveCursor || this.setIndex(void 0), this.forceShow = !1, this.hideCursor(), this.rolledOver =
                    !1);
        },
        ...
        syncWithCursorReal: function(a, b) {
            ...
            this.rotate
                ? (d = NaN, this.vvLine && this.vvLine.hide(), this.hhLine &&
                    e &&
                    (isNaN(a.fy) ? this.hhLine.translate(0, a.mouseY) : this.fixHLine(a.fy, 0)))
                : (f = NaN, this.hhLine && this.hhLine.hide(), this.vvLine &&
                    c &&
...
(function() {
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        draw: function() {
            ...
            if (a.enabled) {
                ...
                if ((a.height = h) && f) {
                    ...
                    n.translate(-(m - c) / 2, -(p - h) / 2);
                    q.translate(-(m - c) / 2, -(p - h) / 2);
                    c = b.set([k, n]);
                    b = b.set([l, q]);
                    a.iconLeft = c;
                    g.push(a.iconLeft);
                    ...
                    void 0 !== a.tabIndex &&
                        (c.setAttr("tabindex", a.tabIndex), c.keyup(function(b) { a.handleKeys(b, 1, 0) }));
                    void 0 !== a.tabIndex &&
                        (f.setAttr("tabindex", a.tabIndex), f.keyup(function(b) { a.handleKeys(b, 1, 1) }));
                    void 0 !== a.tabIndex &&
                        (b.setAttr("tabindex", a.tabIndex), b.keyup(function(b) { a.handleKeys(b, 0, 1) }));
        ...
        updateScrollbarSize: function(a, b) {
            if (!isNaN(a) &&
                ...
                this.rotate
                    ...
                    : (e = a, d = 0, f = b - a, h = this.height + 1, k =
                        b - a, c.setAttr("x", e), c.setAttr("width", k));
        ...
        update: function() {
            ...
            if (k) {
                ...
                if (this.dragging) {
                    ...
                    m
                        ? (a = r + (p - a), 0 > a && (a = 0), r = n - k, a > r && (a = r), h.setAttr("y", a))
                        : (a = r + (t - a), 0 > a && (a = 0), r = q - l, a > r && (a = r), h.setAttr("x", a));
                    this.clipDragger(!0);
                }
                if (this.resizingRight) {
                    if (m)
                        if (a =
                                p - e, !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight),
                            a + e > n + f && (a = n - e + f), 0 > a)
                        ...
                        t - c, !isNaN(this.maxWidth) && a > this.maxWidth && (a = this.maxWidth), a + c > q + d &&
                    (a =
                ...
                if (this.resizingLeft) {
                    if (m)
                        if (c = e, e = p, e < f && (e = f), isNaN(e) && (e = f), e > n + f && (e = n + f), a =
                            !0 === b ? c - e : k + c - e, !isNaN(this.maxHeight) &&
                            a > this.maxHeight &&
                            (a = this.maxHeight, e = c), 0 > a)
                    ...
                    else if (e = t, e < d && (e = d), isNaN(e) && (e = d), e > q + d && (e = q + d), a =
                            !0 === b ? c - e : l + c - e,
        ...
        clipDragger: function(a) {
            ...
            if (b) {
                ...
                if (this.rotate) {
                    ...
                    this.clipW !=
                    g) f = !0;
                f && (this.clipAndUpdate(c, d, g, b), a && (this.updateOnReleaseOnly || this.dispatchScrollbarEvent()));
            }
        },
        maskGraphs: function() {},
        ...
        updateDragIconPositions: function() {
            ...
            this.rotate
                ? (f = this.dragIconWidth, h =
                    this.dragIconHeight, d.translate((k - h) / 2, c - f / 2), g.translate((k - h) / 2,
                    c + a.height - f / 2))
                : (f = this.dragIconHeight,
                    h = this.dragIconWidth, d.translate(b - h / 2, (k - f) / 2), g.translate(b - h / 2 + a.width,
                        (k - f) / 2));
        },
        ...
        handleDragStop: function() {
            ...
            d.isModern &&
                this.dragger.node.setAttribute("style",
        ...
        updateGripCursor: function(a) {
            d.isModern &&
                ...
                (this.iconRight &&
                    this.iconRight.node.setAttribute("style",
                        a), this.iconLeft && this.iconLeft.node.setAttribute("style", a));
        },
        leftDragStop: function() {
            this.resizingLeft &&
            (this.resizingLeft =
                !1, this.mouseIsOver || this.removeCursors(), this.updateOnRelease(), this.fireZoomEvent("zoomEnded"));
        ...
        handleBgClick: function() {
            ...
            if (!a.resizingRight && !a.resizingLeft) {
                ...
                a.updateOnReleaseOnly
                    ...
                    : (a.animating = !0, c =
                        Math.round(c), m ? g.animate({ y: c }, e, ">") : g.animate({ x: c }, e, ">"), a.forceClip =
                        !0, clearTimeout(a.forceTO), a.forceTO =
                        setTimeout(function() { a.stopForceClip.call(a) }, 5E3 * e));
            }
        },
        ...
        handleReleaseOutside: function() {
            if (this.set) {
                if (this.resizingLeft || this.resizingRight || this.dragging)
                    this.dragging = this.resizingRight = this.resizingLeft =
                        !1, this.updateOnRelease(), this.removeCursors();
    ...
    d.ChartScrollbar = d.Class({
        ...
        init: function() {
            ...
            ("CategoryAxis" == this.gridAxis.cname
                ...
                : (a = new d.ValueAxis, a.data = b.chartData, a.id = c.id, a.type = c.type, a.maximumDate =
                    c.maximumDate, a.minimumDate = c.minimumDate, a.minPeriod = c.minPeriod, a.minMaxField =
            ...
            (a = this.graph) &&
                ...
                (c = this.valueAxis,
                    ...
                    (b = new d.AmGraph, b.scrollbar = !0, this.unselectedGraph = b, b.negativeBase =
                        a.negativeBase, b.noStepRisers = a.noStepRisers), b = this.selectedGraph, b ||
        ...
        draw: function() {
            ...
            if (a.enabled) {
                ...
                if ((m = a.graph) && a.catScrollbar) {
                    ...
                    w.zoom(0, c);
                    n.zoom(0, c);
                    n.set.click(function() { a.handleBackgroundClick() }).mouseover(function() { a.handleMouseOver() })
                        .mouseout(function() { a.handleMouseOut() });
                    w.set.click(function() { a.handleBackgroundClick() }).mouseover(function() { a.handleMouseOver() })
                        .mouseout(function() { a.handleMouseOut() });
                    p.push(w.set);
                    p.push(n.set);
                }
        ...
        dispatchScrollbarEvent: function() {
            if (this.categoryAxis && "ValueAxis" == this.categoryAxis.cname)
                ...
                if (k.parseDates && !k.equalSpacing) {
                    if (a = h.lastTime, h = h.firstTime, k = Math.round(b / l) + h, b =
                            this.dragging ? k + this.timeDifference : Math.round((b + c) / l) + h, k > b && (k = b),
                        0 < g &&
                            b - k < g &&
                            (b = Math.round(k + (b - k) / 2), m = Math.round(g / 2), k = b - m, b += m, m =
                                !0), 0 < e &&
                            b - k > e &&
                            (b = Math.round(k + (b - k) / 2), m = Math.round(e / 2), k = b - m, b += m, m =
                                !0), b > a &&
                        (b =
                            a), b - g < k && (k = b - g), k < h && (k = h), k + g > b && (b = k + g),
                        k != this.startTime || b != this.endTime)
                        this.startTime = k, this.endTime = b, f.start = k, f.end = b, f.startDate =
                            new Date(k), f.endDate = new Date(b), this.fire(f);
                } else {
                    k.startOnAxis || (b += l / 2);
                    c -= this.stepWidth / 2;
                    g = k.xToIndex(b);
                    ...
                    if (g != this.start || this.end != b)
                        k.startOnAxis &&
                            (this.resizingRight && g == b && b++, this.resizingLeft &&
                                g == b &&
                                (0 < g ? g-- : b = 1)),
                            this.start = g, this.end = this.dragging ? this.start + this.difference : b, f.start =
                                this.start, f.end = this.end, k.parseDates &&
                            (a[this.start] &&
                                (f.startDate = new Date(a[this.start].time)), a[this.end] &&
                                (f.endDate = new Date(a[this.end].time))), this.fire(f);
                    this.percentStart = g;
                    this.percentEnd = b;
                }
        ...
        zoomScrollbar: function(a) {
            if ((!(this.dragging || this.resizingLeft || this.resizingRight || this.animating) || a) &&
                this.dragger &&
                this.enabled) {
                ...
                g.parseDates && !g.equalSpacing
                    ...
                    : (a[this.start] && (b = a[this.start].x[g.id]),
                        a[this.end] && (c = a[this.end].x[g.id]), a =
                            g.stepWidth, g.startOnAxis || (d = a / 2, b -= d, c += d));
                this.stepWidth = a;
    ...
    d.AmBalloon = d.Class({
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    p.innerHTML = '<div style="text-align:' +
                        this.textAlign +
                        "; " +
                        C +
                        "max-width:" +
                    ...
                    this.drop
                        ? (h = C / 1.6, l =
                                0, "V" == x && (x = "down"), "H" == x && (x = "left"),
                            "down" == x && (D = a + 1, y = b - h - h / 3),
                            "up" == x && (l = 180, D = a + 1, y = b + h + h / 3),
                            "left" == x && (l = 270, D = a + h + h / 3 + 2, y = b),
                            "right" == x && (l = 90, D = a - h - h / 3 + 2, y = b), k = y - H / 2 + 1, m =
                                D - K / 2 - 1, q = d.drop(g, h, l, q, w, r, n, aa))
                        : 0 < u || 0 === z
                        ? (0 < M &&
                        (a = d.rect(g,
                            C,
                            ...
                            P,
                            M,
                            u), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q =
                            d.rect(g, C, A, q, w, r, n, aa, u))
                        : (t = [], u =
                            [], "H" != x
                            ? (h = a - D, h > C - z && (h = C - z), h < z && (h = z), t =
                                [0, h - z, a - D, h + z, C, C, 0, 0], u =
                                Q ? [0, 0, b - y, 0, 0, A, A, 0] : [A, A, b - y, A, A, 0, 0, A])
                            : (x = b - y, x > A - z && (x = A - z), x < z && (x = z), u =
                                [0, x - z, b - y, x + z, A, A, 0, 0], t = a < h + (l - h) / 2
                                ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0]
                                : [C, C, D + C > a ? C : a - D, C, C, 0, 0, C]), 0 < M &&
                            (a = d.polygon(g, t, u, q, 0, r, P, M), a.translate(1, 1), f.push(a)), q =
                            d.polygon(g, t, u, q, w, r, n, aa));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
                    ...
                    this.bottom = y + A + 1;
                    this.yPos = q.y + y;
                    I && I.translate(this.pointToX - D + g, b - y);
                    b = this.animationDuration;
                    0 < this.animationDuration &&
                        !e &&
                        !isNaN(this.prevX) &&
                        (f.translate(this.prevX, this.prevY, NaN, !0),
                            f.animate({ translate: D - g + "," + y }, b, "easeOutSine"), p &&
                            (B.left = this.prevTX + "px", B.top = this.prevTY + "px", this.xAnim = c.animate(
                                { node: p },
                                "left",
                                this.prevTX,
                                m,
                                b,
                                "easeOutSine",
                                "px"), this.yAnim = c.animate({ node: p },
                                "top",
                                this.prevTY,
                                k,
                                b,
        ...
        showBalloon: function(a) {
            if (this.text != a || this.positionChanged)
                this.text = a, this.isHiding = !1, this.show = !0, this.destroyTO && clearTimeout(this.destroyTO), a =
                    this.chart, this.fadeAnim1 && a.stopAnim(this.fadeAnim1), this.fadeAnim2 &&
                    a.stopAnim(this.fadeAnim2), this.draw(), this.positionChanged = !1;
        },
        hide: function(a) {
            var b = this;
            b.text = void 0;
        ...
        followCursor: function(a) {
            ...
            !isNaN(c) &&
                a &&
                (b.pointToX = c - b.offsetX * b.deltaSignX, b.pointToY = d, b.followMouse(), b.interval =
                    setInterval(function() { b.followMouse.call(b) }, 40));
        },
        removeDiv: function() {
            if (this.textDiv) {
...
(function() {
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parsePartSerialData: function(a, b, c, e) {
            ...
            m &&
            (k = m.parseDates, p = m.forceShowField, n = m.classNameField, q = m.labelColorField, l =
                m.categoryFunction);
            var t, r, w = {}, z;
            k &&
            ...
            for (u = b; u < c; u++) {
                ...
                (m.categoryFunction
                    ...
                    : (!A || b instanceof Date || (b = b.toString() + " |"), b = d.getDate(b, A, m.minPeriod)), b =
                    d.resetDateToMin(b, r, t, m.firstDayOfWeek), B.category = b, B.time =
                    b.getTime(), isNaN(B.time))) continue;
        ...
        processValues: function(a, b, c) {
            ...
            for (var h = "value error open close low high".split(" "), k = 0; k < h.length; k++) {
                ...
                var m = a[b[l + "Field"] + c];
                null !== m &&
                (g = Number(m), isNaN(g) || (e[l] = g), "date" == b.valueAxis.type &&
                    void 0 !== m &&
        ...
        parseGraphData: function(a) {
            ...
            for (d = 0; d < b.length; d++) {
                ...
                f &&
                (h = f.axes[h].graphs[a.id], h.serialDataItem = f,
        ...
        processGuides: function() {
            ...
            if (a)
                for (var c = 0; c < a.length; c++) {
                    ...
                    var g = e.valueAxis;
                    g
                        ? (d.isString(g) && (g = this.getValueAxisById(g)), g
                            ? g.addGuide(e)
        ...
        getBalloonColor: function(a, b, c) {
            ...
            b.isNegative &&
            (c = a.negativeLineColor, a =
                    a.negativeFillColors, "object" == typeof a ? c = a[0] : void 0 !== a && (c = a),
                void 0 !== c && (e = c));
        ...
        processFields: function(a, b, c) {
            ...
            e =
                "lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor dashLength pattern gap className columnIndex"
                .split(" ");
        ...
        hideGraph: function(a) {
            a.switchable &&
            (this.dataChanged =
                !0, "xy" != this.type && (this.marginsUpdated = !1), a.hidden =
    ...
    d.TrendLine = d.Class({
        ...
        draw: function() {
            ...
            (l && (l = d.getDate(l, A, "fff"), a.initialDate = l, e = k.dateToCoordinate(l)),
                m && (e = k.categoryToCoordinate(m)), p &&
                    (p = d.getDate(p, A, "fff"), a.finalDate = p, g = k.dateToCoordinate(p)), q &&
                    (g = k.categoryToCoordinate(q)));
            t && !u && (isNaN(r) || (e = t.getCoordinate(r)), isNaN(w) || (g = t.getCoordinate(w)));
            n && !u && (isNaN(z) || (f = n.getCoordinate(z)), isNaN(x) || (h = n.getCoordinate(x)));
            if (!(isNaN(e) || isNaN(g) || isNaN(f) || isNaN(f))) {
                ...
                p = n / Math.abs(n);
                n = 90 * Math.PI / 180 -
                    Math.asin(q / (q * n / Math.abs(q * n) * Math.sqrt(Math.pow(q, 2) + Math.pow(n, 2))));
                q = Math.abs(5 * Math.cos(n));
                n = Math.abs(5 * Math.sin(n));
                e.push(k[1] - m * n, k[0] - m * n);
                g.push(h[1] + p * q, h[0] + p * q);
                ...
                if (f = a.initialImage)
                    f = d.processObject(f, d.Image, a.theme), f.chart =
                        b, f.draw(), f.translate(e[0] + f.offsetX, g[0] + f.offsetY), c.push(f.set);
                if (f = a.finalImage)
                    f = d.processObject(f, d.Image, a.theme), f.chart =
                        b, f.draw(), f.translate(e[1] + f.offsetX, g[1] + f.offsetY), c.push(f.set);
                h.mouseup(function() { a.handleLineClick() }).mouseover(function() { a.handleLineOver() })
        ...
        handleLineOver: function() {
            ...
            this.balloonText &&
            (clearTimeout(this.chart.hoverInt), a = this.line.getBBox(), this.chart.showBalloon(this.balloonText,
                this.lineColor,
                !0,
...
(function() {
    ...
    d.Image = d.Class({
        ...
        draw: function() {
            ...
            c &&
            (c.setAttr("opacity", a.opacity), a.set.rotate(a.rotation), c.translate(-a.width / 2, -a.height / 2, d),
                a.balloonText &&
                    c.mouseover(function() { a.chart.showBalloon(a.balloonText, a.balloonColor, !0) })
                    .mouseout(function() { a.chart.hideBalloon() }).touchend(function() { a.chart.hideBalloon() })
                    .touchstart(function() { a.chart.showBalloon(a.balloonText, a.balloonColor, !0) }), a.set.push(c));
        },
...
(function() {
    ...
    d.polygon = function(a, b, c, e, g, f, h, k, l, m, p) {
        isNaN(f) && (f = .01);
        isNaN(k) && (k = g);
        var q = e, n = !1;
        ...
        void 0 !== p && 0 < p && (g["stroke-dasharray"] = p);
        p = d.dx;
        f = d.dy;
        a.handDrawn &&
        (c = d.makeHD(b,
        ...
        for (var t = 1; t < b.length; t++)
            m && (b[t] = d.roundTo(b[t], 5), c[t] = d.roundTo(c[t], 5)), k +=
                " L" + (h(b[t]) + p) + "," + (h(c[t]) + f);
        a = a.path(k + " Z").attr(g);
        n && a.gradient("linearGradient", e, l);
        return a;
    };
    d.rect = function(a, b, c, e, g, f, h, k, l, m, p) {
    ...
    d.bullet = function(a, b, c, e, g, f, h, k, l, m, p, q, n) {
        var t;
        "circle" == b && (b = "round");
        switch (b) {
        case "round":
        ...
        case "square":
            ...
            break;
        case "rectangle":
            t = d.polygon(a, [-c, c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180, void 0, n);
            break;
        case "diamond":
    ...
    d.line = function(a, b, c, e, g, f, h, k, l, m, p) {
        if (a.handDrawn && !p) return d.handDrawnLine(a, b, c, e, g, f, h, k, l, m, p);
    ...
    d.makeHD = function(a, b, c) {
        for (var d = [], g = [], f = 1; f < a.length; f++)
            for (var h = Number(a[f - 1]),
                ...
                l = Number(a[f]),
                m = Number(b[f]),
                p = Math.round(Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)) / 50) + 1,
                l = (l - h) / p,
                m = (m - k) / p,
                q = 0;
                q <= p;
    ...
    d.wedge = function(a, b, c, e, g, f, h, k, l, m, p, q, n, t) {
        var r = Math.round;
        f = r(f);
        h = r(h);
        k = r(k);
        ...
        var M;
        z &&
        (x = r(10 * x), y = r(10 * y), D = r(10 * D), K = r(10 * K), A = r(10 * A), B = r(10 * B), C =
            r(10 * C), u = r(10 * u), b = r(10 * b), l = r(10 * l), c =
            r(10 * c), f *= 10, h *= 10, k *= 10, w *= 10, 1 > Math.abs(g) &&
            1 >= Math.abs(D - y) &&
            1 >= Math.abs(C - B) &&
            (M = !0));
        g = "";
        ...
        if (0 < l) {
            ...
            z
                ...
                (P += " B" +
                    ...
                    "," +
                    (l + A))))
                : (P += " A" + f + "," + h + ",0," + Q + ",1," + D + "," + (C + l) + " L" + K + "," + (u + l), 0 < k &&
                    (P += " A" + k + "," + w + ",0," + Q + ",0," + x + "," + (A + l)));
            P += " Z";
            var ia = l;
            z && (ia /= 10);
        ...
        z
            ...
            (g = " A" +
                ...
                r(D) +
                "," +
                r(C)), h = " M" + r(x) + "," + r(A) + " L" + r(y) + "," + r(B) + g + " L" + r(K) + "," + r(u))
            : h = " M" +
            x +
            "," +
            A +
        ...
        d.isModern &&
            "radial" == t &&
            a.grad &&
            (a.grad.setAttribute("gradientUnits", "userSpaceOnUse"), a.grad.setAttribute("r", f),
                a.grad.setAttribute("cx", b), a.grad.setAttribute("cy", c));
        a.pattern(q, NaN, n);
        e.wedge = a;
        e.push(a);
        return e;
    ...
    d.adjustLuminosity = function(a, b) {
        ...
        for (g = 0; 3 > g; g++)
            e = parseInt(a.substr(2 * g, 2), 16), e =
                Math.round(Math.min(Math.max(0, e + e * b), 255)).toString(16), c += ("00" +
                e).substr(e.length);
        return c;
    };
})();
(function() {
    var d = window.AmCharts;
    d.Bezier = d.Class({
        construct: function(a, b, c, e, g, f, h, k, l, m, p) {
            ...
            for (l = 0; l < b.length; l++)
                isNaN(b[l]) || isNaN(c[l])
                    ? (e += this.drawSegment(g, n, t), l < b.length - 1 && (e += "L" + b[l + 1] + "," + c[l + 1] + " "),
                        g = [])
                    : g.push({ x: Number(b[l]), y: Number(c[l]) });
            e += this.drawSegment(g, n, t);
            ...
            if (2 < a.length)
                for (var g = 0; g < a.length - 1; g++) {
                    ...
                    0 === g
                        ...
                        : g >= a.length - 2
                        ? (f.push({ x: h.x, y: h.y }), f.push({ x: k.x, y: k.y }), f.push({ x: l.x, y: l.y }),
                            f.push({ x: l.x, y: l.y }))
                        : (f.push({ x: h.x, y: h.y }), f.push({ x: k.x, y: k.y }), f.push({ x: l.x, y: l.y }), f.push({
                            x: m.x,
                            y: m.y
                        }));
                    h = [];
        ...
        addDefs: function(a) {
            if (d.hasSVG) {
                ...
                (a.addCodeCredits &&
                    ...
                    (b = this.createSvgElement("defs"), c.appendChild(b), d.parseDefs(a.defs,
                        b), this.defs = b));
            }
        }
    });
    ...
    d.VMLRenderer = d.Class({
        ...
        setAttr: function(a, b, c) {
            if (void 0 !== c) {
                ...
                "text" == f &&
                ("text-anchor" == b &&
                    (a.anchor = c, k = g.clientWidth, "end" == c && (h.marginLeft = -k + "px"), "middle" == c &&
                    (h.marginLeft = -(k / 2) +
                        "px", h.textAlign = "center"), "start" == c && (h.marginLeft = "0px")),
                ...
                if ("shape" == f) {
                    ...
                    "stroke-dasharray" == b &&
                    (h = "solid", 0 < c && 3 > c && (h = "dot"), 3 <= c && 6 >= c && (h = "dash"),
                        6 < c && (h = "longdash"), e ? f.dashstyle = h : f.setAttribute("dashstyle", h));
...
(function() {
    ...
    d.SVGRenderer = d.Class({
        ...
        animate: function(a, b, c, e, g) {
            ...
            "translate" == b
                ? (f = (f = f.getAttribute("transform"))
                    ? String(f).substring(10,
                        f.length - 1)
                    : "0,0", f = f.split(", ").join(" "), f = f.split(" ").join(","), 0 === f && (f = "0,0"))
            ...
            for (a = b.length - 1; 0 <= a; a--) {
                ...
                if (g <= e) {
                    ...
                    "translate" == h
                        ...
                        : (k = Number(c.to), this.setAttr(f, h, k)), f.animationFinished =
                        !0, this.animations.splice(a, 1);
            }
        },
        getBBox: function(a) {
        ...
        pattern: function(a, b, c, e) {
            ...
            b.color &&
            (p = document.createElementNS(d.SVG_NS, "rect"), p.setAttributeNS(null, "height", e),
                p.setAttributeNS(null, "width", l), p.setAttributeNS(null, "fill", b.color), f.appendChild(p));
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend: function() {
            ...
            if (g = this.title)
                g =
                        d.text(this.container, g, this.color, a.fontFamily, this.fontSize, "start", !0),
                    d.setCN(a, g, "legend-title"), g.translate(this.marginLeft,
                        this.marginTop + this.verticalGap + this.ly + 1), a = g.getBBox(), this.titleWidth =
        ...
        arrangeEntries: function() {
            ...
            l = u.height + 2 * m - 1;
            "left" == a || "right" == a
                ? (p = u.width + 2 * f, k = p + b + c, h.style.width = k + "px", this.ieW = k)
                : p = k - b - c - 1;
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    ...
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e)
                        m = q.set(), a.hidden || (f = a.lineColorR, k = a.bulletBorderColorR), t = d.line(q,
                            [
                                0, 2 *
                                n
                            ],
                            ...
                            a.lineAlpha,
                            a.lineThickness,
                            a.dashLength), d.setCN(c, t, "graph-stroke"), m.push(t), a.bullet &&
                            (a.hidden || (f = a.bulletColorR), t =
                                d.bullet(q,
                                    a.bullet,
                                    a.bulletSize,
                                    f,
                                    ...
                                    k,
                                    a.bulletBorderAlpha)) &&
                            (d.setCN(c, t, "graph-bullet"), t.translate(n + 1, n / 2), m.push(t)), w = 0, t = n, r =
                            n / 3;
                    else {
                        a.getGradRotation && (m = a.getGradRotation(), 0 === m && (m = 180));
                        t = a.fillColorsR;
                        !0 === a.hidden && (t = f);
                        if (m = b.createMarker("rectangle",
                            t,
                            a.fillAlphas,
                            a.lineThickness,
                            f,
                    ...
                    (m = b.createMarker(g, f, h, void 0, void 0, void 0, z, l)) && m.translate(n / 2, n / 2);
                }
                ...
                k &&
                    ...
                    ("x" == k
                            ? (x = b.createX(),
                                x.translate(n / 2, n / 2))
                            : x = b.createV(), x.dItem =
                            a, !0 !== a.hidden ? "x" == k ? x.hide() : x.show() : "x" != k && x.hide(),
                        b.switchable || x.hide(), b.addListeners(x, a), a.legendSwitch =
                            x, q.push(x), d.setCN(c, x, "legend-switch"));
                k = b.color;
                ...
                void 0 !== b.tabIndex &&
                (q.setAttr("tabindex", b.tabIndex), q.setAttr("role", "menuitem"),
                ...
                m &&
                (n <= l &&
                        (n = n / 2 + b.ly - l / 2 + (l + 2 - n) / 2 - r, m.translate(w, n), x && x.translate(x.x, n)),
                    a.legendEntryWidth = m.getBBox().width);
                var u;
                f &&
                (f = d.fixBrakes(f), a.legendTextReal = f, u = b.labelWidth, u =
                        isNaN(u)
                        ? d.text(b.container, f, k, c.fontFamily, l, "start")
                        : d.wrappedText(b.container, f, k, c.fontFamily, l, "start", !1, u, 0), d.setCN(c,
                        u,
                        "legend-label"),
                    u.translate(b.lx + t, b.ly), q.push(u), b.labelDx = t, c =
                        u.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
                b.entries[b.index] = q;
        ...
        createMarker: function(a, b, c, e, g, f, h, k, l) {
            ...
            return d.bullet(p, a, m, b, c, e, g, f, m, h, k, this.chart.path, l);
        },
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e) f.value ? g.text(f.value) : g.text("");
                        ...
                        f.legendColorFunction &&
                            (p = f.legendColorFunction(l, h, f.periodDataItem, f.periodPercentDataItem));
                        g.text(h);
                        if (!f.pattern &&
                            (this.useMarkerColorForValues && g.setAttr("fill", p), this.useMarkerColorForLabels)) {
                            if (g = f.legendMarker) g.setAttr("fill", p), g.setAttr("stroke", p);
...
(function() {
    ...
    d.resetDateToMin = function(a, b, c, e) {
        ...
        var g, f, h, k, l, m, p;
        d.useUTC
            ? (g = a.getUTCFullYear(), f = a.getUTCMonth(), h = a.getUTCDate(), k = a.getUTCHours(), l =
                a.getUTCMinutes(), m = a.getUTCSeconds(), p = a.getUTCMilliseconds(), a = a.getUTCDay())
            : (g = a.getFullYear(), f = a.getMonth(), h = a.getDate(), k = a.getHours(), l =
        ...
        d.useUTC
            ? (a = new Date, a.setUTCFullYear(g, f, h), a.setUTCHours(k, l, m, p))
            : a = new Date(g,
                f,
                h,
                k,
    ...
    d.stringToDate = function(a, b) {
        var c = {},
            e = [
                ...
                { pattern: "QQ", period: "milliseconds" }, { pattern: "Q", period: "milliseconds" }
            ],
            g = !0,
            f = b.indexOf("AA");
    ...
    d.formatDate = function(a, b, c) {
        c || (c = d);
        var e, g, f, h, k, l, m, p, q = d.getWeekNumber(a);
        d.useUTC
            ? (e = a.getUTCFullYear(), g = a.getUTCMonth(), f = a.getUTCDate(), h = a.getUTCDay(), k =
                a.getUTCHours(), l = a.getUTCMinutes(), m = a.getUTCSeconds(), p = a.getUTCMilliseconds())
            : (e = a.getFullYear(), g = a.getMonth(), f = a.getDate(), h = a.getDay(), k = a.getHours(), l =
                a.getMinutes(), m = a.getSeconds(), p = a.getMilliseconds());
        var n = String(e).substr(2, 2), t = "0" + h;
        b = b.replace(/W/g,
            q);
        q = k;
        24 == q && (q = 0);
        ...
        (r = 24, -1 != b.indexOf("H") &&
        (f--, 0 === f &&
            (e = new Date(a), e.setDate(e.getDate() - 1), g = e.getMonth(), f = e.getDate(), e = e.getFullYear())));
        a = g + 1;
        9 > g && (a = "0" + a);
        q = f;
        10 > f && (q = "0" + f);
