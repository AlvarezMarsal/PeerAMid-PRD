    ...
    e.AmRectangularChart = e.Class({
        ...
        measureMargins: function() {
            ...
            for (l = 0; l < a.length; l++)
                a[l].handleSynchronization(), b = this.getAxisBounds(a[l], f, m, k, b), f = Math.round(b.l), m =
                    Math.round(b.r), k = Math.round(b.t), b = Math.round(b.b);
            if (a = this.categoryAxis)
                b = this.getAxisBounds(a, f, m, k, b), f = Math.round(b.l), m = Math.round(b.r), k =
            ...
            d.right &&
                m >= g - c &&
                (this.marginRight = Math.round(m - g + c), !isNaN(this.minMarginRight) &&
                    this.marginRight < this.minMarginRight &&
                    (this.marginRight = this.minMarginRight));
            d.top &&
                k < c + this.titleHeight &&
                (this.marginTop = Math.round(this.marginTop - k + c + this.titleHeight), !isNaN(this.minMarginTop) &&
                    this.marginTop < this.minMarginTop &&
                    (this.marginTop = this.minMarginTop));
            d.bottom &&
                b > e - c &&
                (this.marginBottom = Math.round(this.marginBottom + b - e + c), !isNaN(this.minMarginBottom) &&
        ...
        drawZoomOutButton: function() {
            ...
            if (!a.zbSet) {
                ...
                l &&
                (l.fontSize && (d = l.fontSize), l.color && (c = l.color),
                    l.backgroundColor && (k = l.backgroundColor), isNaN(l.backgroundAlpha) ||
                ...
                (c = e.text(a.container, f, c, a.fontFamily, d, "start"), e.setCN(a, c, "zoom-out-label"), d =
                    c.getBBox(), r = q ? q.height / 2 - 3 : d.height / 2, c.translate(l, r), b.push(c));
                q = b.getBBox();
                c = 1;
                e.isModern || (c = 0);
        ...
        drawPlotArea: function() {
            ...
            const d = this.marginTopReal;
            var g = this.plotAreaWidth - 1;
            const h = this.plotAreaHeight - 1;
            var f = this.plotAreaFillColors,
                k = this.plotAreaFillAlphas;
            const m = this.plotAreaBorderColor;
            const l = this.plotAreaBorderAlpha;
            ...
            0 !== a &&
                ...
                (f = this.plotAreaFillColors, "object" == typeof f && (f = f[0]), f = e.adjustLuminosity(f, -.15), g =
                        e.polygon(this.container, [0, a, g + a, g, 0], [0, b, b, 0, 0], f, k, 1, m, l),
                    e.setCN(this, g, "plot-area-bottom"), g.translate(c, d + h), this.set.push(g), a =
                        e.polygon(this.container, [0, 0, a, a, 0], [0, h, h + b, b, 0], f, k, 1, m, l), e.setCN(this,
                        a,
        ...
        updatePlotArea: function() {
            ...
            var c = this.marginLeftReal;
            const d = this.marginTopReal;
            var a = a - c - this.marginRightReal - this.dx,
        ...
        removeTrendLine: function(a) {
            const b = this.trendLines;
            var c;
            for (c = b.length - 1; 0 <= c; c--) b[c] == a && b.splice(c, 1);
        },
        adjustMargins: function(a, b) {
            const c = a.position;
            const d = a.scrollbarHeight + a.offset;
            a.enabled &&
            ("top" == c
                ? b
        ...
        updateChartScrollbar: function(a, b) {
            if (a) {
                a.rotate = b;
                const c = this.marginTopReal;
                const d = this.marginLeftReal;
                const e = a.scrollbarHeight;
                const h = this.dx;
                const f = this.dy;
                const k = a.offset;
                "top" == a.position
                    ...
                    : (a.y = c - e + f - k, a.x = d + h)
                    : b
                    ? (a.y = c + f, a.x = d + this.plotAreaWidth + h + k)
        ...
        zoomValueScrollbar: function(a) {
            if (a && a.enabled) {
                const b = a.valueAxes[0];
                let c = b.relativeStart;
                let d = b.relativeEnd;
        ...
        relativeZoomValueAxes: function(a, b, c) {
            ...
            if (a) {
                for (g = 0; g < a.length; g++) {
                    const h = a[g].zoomToRelativeValues(b, c, !0);
                    h && (d = h);
                }
                this.showZB();
            }
        ...
        handleCursorZoom: function(a) {
            if (this.skipZoomed) this.skipZoomed = !1;
                ...
                const b = this.startX0;
                const c = this.endX0;
                const d = this.endY0;
                const e = this.startY0;
                const h = a.startX;
                const f = a.endX;
                const k = a.startY;
                const m = a.endY;
...
(function() {
    ...
    e.AmXYChart = e.Class({
        ...
        initChart: function() {
            ...
            const a = this.marginLeftReal;
            const b = this.marginTopReal;
            const c = this.plotAreaWidth;
            const d = this.plotAreaHeight;
        ...
        createValueAxes: function() {
            ...
            0 === b.length &&
                (d = new e.ValueAxis(this.theme), d.rotate = !1, d.setOrientation(!1), c.push(d), b.push(d));
            0 === a.length &&
                (d = new e.ValueAxis(this.theme), d.rotate = !0, d.setOrientation(!0), c.push(d), a.push(d));
                    ...
                    for (k = 0; k < b.length; k++) {
                        ...
                        for (l = 0; l < c.length; l++) {
                            ...
                            if (p.xAxis.id == m || p.yAxis.id == m) {
                                ...
                                n = f[p.xField];
                                null !== n &&
                                ("date" == p.xAxis.type && (n = e.getDate(f[p.xField], h).getTime()), n =
                                    Number(n), isNaN(n) || (t.x = n));
                                n = f[p.yField];
                                null !== n &&
                                ("date" == p.yAxis.type && (n = e.getDate(f[p.yField], h).getTime()), n =
                                    Number(n), isNaN(n) || (t.y = n));
                                n = f[p.errorField];
        ...
        formatString: function(a, b, c) {
            const d = b.graph;
            var g = d.numberFormatter;
            g || (g = this.nf);
            var h, f;
            "date" == b.graph.xAxis.type &&
            (h = e.formatDate(new Date(b.values.x), d.dateFormat, this), f = RegExp("\\[\\[x\\]\\]", "g"), a =
                a.replace(f, h));
            "date" == b.graph.yAxis.type &&
            (h = e.formatDate(new Date(b.values.y), d.dateFormat, this), f = RegExp("\\[\\[y\\]\\]", "g"), a =
                a.replace(f, h));
        ...
        addChartScrollbar: function(a) {
            ...
            if (a) {
                ...
                this.hideXScrollbar ||
                (c = new e.ChartScrollbar(this.theme), c.skipEvent = !0, c.chart =
                        this, this.listenTo(c, "zoomed", this.handleScrollbarValueZoom), e.copyProperties(a, c, b),
                    c.rotate = !1, this.scrollbarH = c);
            }
        },
        ...
        updateMargins: function() {
            ...
            if (a = this.scrollbarH)
                this.getScrollbarPosition(a, !1, this.xAxes[0].position), this.adjustMargins(a, !1);
        },
        updateScrollbars: function() {
            e.AmXYChart.base.updateScrollbars.call(this);
            var a = this.scrollbarV;
            a &&
            (this.updateChartScrollbar(a, !0), a.valueAxes =
                this.yAxes, a.gridAxis || (a.gridAxis = this.yAxes[0]));
            if (a = this.scrollbarH)
                this.updateChartScrollbar(a, !1), a.valueAxes = this.xAxes, a.gridAxis || (a.gridAxis = this.xAxes[0]);
        },
        ...
        handleCursorZoomStarted: function() {
            ...
            this.yAxes &&
            (a = this.yAxes[0], this.startY0 = a.relativeStart, this.endY0 =
                a.relativeEnd, a.reversed && (this.startY0 = 1 - a.relativeEnd, this.endY0 = 1 - a.relativeStart));
        },
        updateChartCursor: function() {
            ...
            if (a) {
                ...
                if (a.valueLineBalloonEnabled) {
                    ...
                    let d = a.categoryBalloonColor;
                    const g = a.color;
                    void 0 === d && (d = a.cursorColor);
                    for (let h = 0; h < this.valueAxes.length; h++) {
                ...
                a.zoomable &&
                    (this.hideYScrollbar || (a.vZoomEnabled = !0), this.hideXScrollbar || (a.hZoomEnabled = !0));
            }
        },
